      ...
      <div className="p-4 flex-1 flex flex-col justify-between">
        <div className="flex items-center justify-between py-2">
          ...
          <div className="flex-1 text-center">
            ...
            <span className="text-2xl md:text-3xl font-black text-emerald-600 tracking-tight">
              165,0 <span className="text-sm font-bold ml-0.5">т</span>
            </span>
          </div>
          ...
          <div className="flex-1 text-center">
            ...
            <span className="text-2xl md:text-3xl font-black text-emerald-600 tracking-tight">
              4 910,9 <span className="text-sm font-bold ml-0.5">т</span>
            </span>
          </div>
        </div>
        ...
        <div className="text-center py-1">
          <span className="text-xs font-bold text-slate-600">
            Среднесуточный выпуск за июль:{' '}
            <span className="text-blue-900 font-extrabold">158,4 т</span>
          </span>
        </div>
      </div>
    </div>
